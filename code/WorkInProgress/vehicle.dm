...
/obj/machinery/vehicle/space_ship/New()
	..()
...
/obj/machinery/vehicle/space_ship/process()
	return

/obj/machinery/vehicle/space_ship/proc/get_desired_speed()
...
/obj/machinery/vehicle/space_ship/proc/get_current_speed()
