/obj/vehicle/scooter
	...
	icon = 'icons/tgstation/obj/vehicles.dmi'
	icon_state = "scooter"
...
/obj/vehicle/scooter/buckle_mob(mob/living/carbon/human/M, force = 0)
	if(!istype(M))
		return 0
...
/obj/vehicle/scooter/post_buckle_mob(mob/living/carbon/human/M)
...
/obj/vehicle/scooter/skateboard/Bump(atom/A)
	...
	if(A.density && has_buckled_mobs())
		var/mob/living/carbon/H = buckled_mob
