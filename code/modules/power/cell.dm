...
/obj/item/weapon/cell/infinite/slime
	name = "infinite-capacity slime core!"
	desc = "A shiny yellow slime core infused with plasma, it has UNLIMITED POWER!"
	icon_state = "gold slime extract"

// TODO: Make Doc spawn with one of these if he ever plays :3
