...
/world/Reboot(var/reason, var/feedback_c, var/feedback_r, var/time)
	...
	spawn(0)
		world << sound(pick('sound/AI/newroundsexy.ogg','sound/misc/apcdestroyed.ogg','sound/misc/bangindonk.ogg', 'sound/goonstation/misc/newround1.ogg', 'sound/misc/billychristmas.ogg', 'sound/misc/thatwasinteresting.ogg'))// random end sounds!! - LastyBatsy
