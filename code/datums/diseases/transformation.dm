...
/*
/datum/disease/transformation/cat
	name = "Mewingitis"
	cure = "Death"
	agent = "Fell Cat Majicks"
	hidden = list(0, 0)
	stage1	= list("Mew.")
	stage2	= list("You feel the need to be pet on the head.")
	stage3	= list("\red ...", "\red Meow.")
	stage4	= list("\red ")
	stage5	= list("\red Hisssssssss!!!")
	new_form = /mob/living/simple_animal/cat

/datum/disease/transformation/cat/stage_act()
	..()
	switch(stage)
		if(3)
			if (prob(8))
				affected_mob.say(pick("Purrr", "Meow"))
		if(4)
			if (prob(20))
				affected_mob.say(pick("Mew", "Hissssss!"))
*/
