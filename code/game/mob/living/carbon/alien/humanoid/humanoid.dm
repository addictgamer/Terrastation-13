...
/mob/living/carbon/alien/humanoid
	...
	icon_state = "alien_s"
	var
		obj/item/clothing/suit/wear_suit = null
		obj/item/clothing/head/head = null
		obj/item/weapon/r_store = null
		obj/item/weapon/l_store = null
		icon/stand_icon = null
		icon/lying_icon = null
		last_b_state = 1.0
		image/face_standing = null
		image/face_lying = null
		list/body_standing = list(  )
		list/body_lying = list(  )
...
*/
	...
	attack_metroid(mob/living/carbon/metroid/M as mob)
		if (!ticker)
			M << "You cannot attack people before the game has started."
			return
...
*/
	...
	proc
		mind_initialize(mob/G, alien_caste)
			mind = new
			mind.current = src
