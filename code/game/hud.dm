...
/obj/hud
	...
	var
		...
		obj/screen/station_explosion = null
...
/////////////////
		...
		brain_hud(var/ui_style='screen1_old.dmi')
			station_explosion = new h_type( src )
			station_explosion.icon = 'station_explosion.dmi'
			station_explosion.icon_state = "start"
			station_explosion.layer = 20
...
/////////////////
		...
		human_hud(var/ui_style='screen1_old.dmi')
			src.adding = list(  )
			src.other = list(  )
			src.intents = list(  )
			src.mon_blo = list(  )
...
//////////////////
		...
		monkey_hud(var/ui_style='screen1_old.dmi')
			src.adding = list(  )
			src.other = list(  )
			src.intents = list(  )
			src.mon_blo = list(  )
