...
/obj/closet/fireaxecabinet/attackby(var/obj/item/O as obj, var/mob/user as mob)  //Marker -Agouri
...
/obj/closet/fireaxecabinet/verb/toggle_openness() //nice name, huh? HUH?! -Erro //YEAH -Agouri
	set name = "Open/Close"
	set category = "Object"
...
/obj/closet/fireaxecabinet/verb/remove_fire_axe()
...
/obj/closet/fireaxecabinet/attack_paw(mob/user as mob)
	attack_hand(user)
	return
...
/obj/closet/fireaxecabinet/open()
	return

/obj/closet/fireaxecabinet/close()
	return
