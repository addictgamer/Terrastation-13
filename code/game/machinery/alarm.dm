/*
 * Terrastation modifications to this file:
 * * Fire alarm plays the fire alarm sound.
 */
...
/obj/machinery/firealarm/proc/alarm(var/duration = 0)
	...
	//if(!A.fire) //Is this if check still needed? - Cip
		//world << sound('sound/machines/firealarm.ogg') //This doesn't work anymore. - Cip
	playsound(src.loc, 'sound/machines/firealarm.ogg', 75, 1)
	return
