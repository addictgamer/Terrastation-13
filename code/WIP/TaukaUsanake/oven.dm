...
//TODO: Stealing from microwave object to make this. Need to find out how it works so as to separate from microwave
...
/obj/machinery/microwave
	...
	var
		...
		global
			list/datum/recipe/available_recipes	// List of the recipes you can use
			list/acceptable_items	// List of the items you can put in
			list/acceptable_reagents	// List of the reagents you can put in
			max_n_of_items = 0

// see code\datum\recipe\ for recipes
